...
@section('content')
<div class="container">
    <h3 align="center" class="p-5"><b>e-Campus</b> Library</h3>
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-primary text-white"><b>{{ __('Registration') }}</b></div>
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password-confirm" type="password"placeholder="Masukkan confirm password"  class="form-control" name="password_confirmation" required autocomplete="new-password">
                            </div>
                        </div><br>
